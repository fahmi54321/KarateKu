...
public class PhotoPassportAct extends AppCompatActivity {

    Button bttnUploadScanPassport,bttnContinue;
    ImageView ScanPassport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_passport);
        ...
        bttnUploadScanPassport = findViewById(R.id.bttnUploadScanPassport);
        bttnContinue = findViewById(R.id.bttnContinue);
        ScanPassport = findViewById(R.id.ScanPassport);

        bttnUploadScanPassport.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        bttnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                storage = FirebaseStorage.getInstance().getReference().child("PhotoScan").child("ScanPassport").child(nama);
                ...
                if(photo_location !=null)
                {
                    ...
                    storageReference1.putFile(photo_location).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            if(taskSnapshot.getMetadata()!=null)
                            {
                                ...
                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        reference.getRef().child("url_scan_passport").setValue(imageUrl);
                                    }
                                });
                            }
                        }
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            Intent gotosuccesregister = new Intent(PhotoPassportAct.this,RegisterSuccessDuaAct.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==photo_max && resultCode==RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            Picasso.with(this).load(photo_location).centerCrop().fit().into(ScanPassport);
            bttnUploadScanPassport.setVisibility(View.GONE);
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            startActivity(new Intent(PhotoPassportAct.this, TentangAct.class));
        }
        return true;
    }
}
