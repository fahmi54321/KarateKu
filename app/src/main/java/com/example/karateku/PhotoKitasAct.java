...
public class PhotoKitasAct extends AppCompatActivity {

    Button bttnUploadScanKitas,bttnContinue;
    ImageView ScanKitas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photo_kitas);
        ...
        bttnUploadScanKitas = findViewById(R.id.bttnUploadScanKitas);
        bttnContinue = findViewById(R.id.bttnContinue);
        ScanKitas = findViewById(R.id.ScanKitas);

        bttnUploadScanKitas.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        bttnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                storage = FirebaseStorage.getInstance().getReference().child("PhotoScan").child("ScanKitas").child(nama);
                ...
                if(photo_location !=null)
                {
                    ...
                    storageReference1.putFile(photo_location).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            if(taskSnapshot.getMetadata()!=null)
                            {
                                ...
                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        reference.getRef().child("url_scan_kitas").setValue(imageUrl);
                                    }
                                });
                            }
                        }
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            Intent gotosuccesregister = new Intent(PhotoKitasAct.this,RegisterSuccessDuaAct.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode==photo_max && resultCode==RESULT_OK && data!=null && data.getData()!=null)
        {
            ...
            Picasso.with(this).load(photo_location).centerCrop().fit().into(ScanKitas);
            bttnUploadScanKitas.setVisibility(View.GONE);
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            startActivity(new Intent(PhotoKitasAct.this, TentangAct.class));
        }
        return true;
    }
}
